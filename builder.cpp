...
namespace builder
{
	...
	public:
		...
		void setMHealthRate(float aRate)
		{
	...
	{
	public:
		void setBuilder(std::unique_ptr<IBuilder> pBuilder)
		{
			mBuilder = std::move(pBuilder);
		}
	...
	class MagicDirtyAnt : public IBuilder
	{
	public:
	...
	class PhysicalDirtyAnt : public IBuilder
	{
	public:
